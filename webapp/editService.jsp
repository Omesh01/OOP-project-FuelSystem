						...
						%>
	                        <form action="editService" method="post">
	                            ...
	                            <div class="form-group row">
	                                ...
	                                <div class="col-md-6">
	                                    <input type="text" id="name" class="form-control" name="name" value="<%=service.getName() %>" required>
	                                </div>
	                            </div>
	                            ...
	                            <div class="form-group row">
	                                ...
	                                <div class="col-md-6">
	                                    <select name="status" class="form-control" required>
	                                		<option><%=service.getStatus() %></option>
											<option>test</option>
	                                	</select>
	                                </div>
	                            </div>
	                            ...
	                            <div class="form-group row">
	                                <label for="email_address" class="col-md-4 col-form-label text-md-right">Fee</label>
	                                <div class="col-md-6">
	                                    <input type="number" id="fee" class="form-control" name="fee" value="<%=service.getFee() %>" required>
	                                </div>
	                            </div>
