	        ...
	        <div class="row justify-content-center">
	            <div class="col-md-8">
	                <div class="card">
						...
						%>
	                        <form action="editFuel" method="post">
	                            ...
	                            <div class="form-group row">
	                                ...
	                                <div class="col-md-6">
	                                    <input type="number" id="stock_volume" class="form-control" name="stock_volume" value="<%=fuel.getStock_volume() %>" required>
	                                </div>
	                            </div>
	                            ...
	                            <div class="form-group row">
	                                ...
	                                <div class="col-md-6">
	                                    <input type="number" id="intial_volume" class="form-control" name="intial_volume" value="<%=fuel.getIntial_volume() %>" required>
	                                </div>
	                            </div>
	                            ...
	                            <div class="form-group row">
	                                ...
	                                <div class="col-md-6">
	                                    <input type="date" id="date_recieved" class="form-control" name="date_recieved" value="<%=fuel.getDate_recieved() %>" required>
	                                </div>
	                            </div>
	                            ...
	                            <div class="form-group row">
	                                ...
	                                <div class="col-md-6">
	                                    <input type="date" id="date_consumed" class="form-control" name="date_consumed" value="<%=fuel.getDate_consumed() %>" required>
	                                </div>
	                            </div>
