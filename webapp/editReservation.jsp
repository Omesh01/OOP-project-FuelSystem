						...
						%>
	                        <form action="editReservation" method="post">
	                            ...
	                            <div class="form-group row">
	                                <label class="col-md-4 col-form-label text-md-right">Service Type</label>
	                                <div class="col-md-6">
	                                    <select name="service_type" class="form-control" required>
	                                		<option><%=reservation.getService_type() %></option>
											<option>test</option>
	                                	</select>
	                                </div>
	                            </div>
	                            ...
	                            <div class="form-group row">
	                                <label class="col-md-4 col-form-label text-md-right">Vehicle No</label>
	                                <div class="col-md-6">
	                                    <input type="text" id="vehicle_no" class="form-control" name="vehicle_no" value="<%=reservation.getVehicle_no() %>" required>
	                                </div>
	                            </div>
	                            ...
	                            <div class="form-group row">
	                                ...
	                                <div class="col-md-6">
	                                    <select name="payment_status" class="form-control" required>
	                                		<option><%=reservation.getPayment_status() %></option>
											<option>test</option>
	                                	</select>
	                                </div>
	                            </div>
