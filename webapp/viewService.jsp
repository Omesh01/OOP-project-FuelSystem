...
<p></p>
	            ...
	            <div class="col-md-10">
	                <div class="card">
	                	...
	                	<%
							...
							ArrayList<Service> arrayList = ss.getServices();
							
							for (Service service : arrayList) {
								
								
						%><tr>
							<td class="tableTh"><%=service.getId() %></td>
							<td class="tableTh"><%=service.getName() %></td>
							<td class="tableTh"><%=service.getStatus() %></td>
							<td class="tableTh"><%=service.getFee() %></td>
							<td class="tableTh"><a class="btn btn-success" href="getService?id=<%=service.getId() %>" >Edit</a></td>
							<td class="tableTh"><Button class="btn btn-danger" id="<%=service.getId() %>" onclick="clickDelete(this);">Delete</Button></td>
						  </tr>
						<%
							}
						%>
	...
	<div style="display: none;" >
    	<form action="deleteService" method="post" id="settingsForm">
