...
<p></p>
	            ...
	            <div class="col-md-10">
	                <div class="card">
	                	...
	                	<%
							...
							ArrayList<Customer> arrayList = s.getCustomers();
							
							for (Customer cus : arrayList) {
								
								
						%><tr>
							<td class="tableTh"><%=cus.getId() %></td>
							<td class="tableTh"><%=cus.getName() %></td>
							<td class="tableTh"><%=cus.getEmail() %></td>
							<td class="tableTh"><%=cus.getPhone() %></td>
							<td class="tableTh"><%=cus.getVehicleno() %></td>
							<td class="tableTh"><a class="btn btn-success" href="getCustomer?id=<%=cus.getId() %>" >Edit</a></td>
							<td class="tableTh"><Button class="btn btn-danger" id="<%=cus.getId() %>" onclick="clickDelete(this);">Delete</Button></td>
						  </tr>
						<%
							}
						%>
	...
	<div style="display: none;" >
    	<form action="deleteCustomer" method="post" id="settingsForm">
